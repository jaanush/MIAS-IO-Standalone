...
type RepoInfo = {
  latest: { version: string; filename: string; size: number; downloadUrl: string } | null;
};

export default function SettingsRemotePage() {
    ...
    <div className="flex-1 overflow-auto p-6 space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Active plugin connections and downloads.
        </p>
      </div>
                ...
                <div key={s.id} className="px-4 py-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 flex-wrap justify-end">
                    ...
                    {latestVersion && s.pluginVersion !== latestVersion && (
                      <Badge
                        variant="outline"
                        className="text-[10px] bg-amber-50 text-amber-700 border-amber-300 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-700"
                      >
